...
#if defined(CONFIG_MACH_CP8675) || defined(CONFIG_HUAWEI_KERNEL)
...
#ifdef CONFIG_HUAWEI_KERNEL_2
/* huawei: ignore the btn3~7, only clear the mask, do not report */
	else
	{
		pr_debug("%s: HUAWEI-- ignore reporting btn3~7 !\n",
					 __func__);
