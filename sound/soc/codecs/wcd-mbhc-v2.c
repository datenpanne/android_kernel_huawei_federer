...
/* < DTS2014050500963 yubin 20140505 begin */
...
#endif
#ifndef DEBUG
/* < DTS2015073008247  penghongxing 20150806 begin */
#define DEBUG
#endif
#endif
/* DTS2014050500963 yubin 20140505 end > */
...
/* < DTS2015081903806 lugandong 20150821 begin */
#include <linux/string.h>
/* DTS2015081903806 lugandong 20150821 end > */
#include <sound/pcm.h>
...
/*< DTS2016030410779 chaofubang 20160315 begin */
#define SPECIAL_HS_DETECT_TIME_MS (100)
/*< DTS2016030410779 chaofubang 20160315 end */
...
/* < DTS2015081900979 huangwei/wx223581 20150819 begin */
#define FAKE_REM_RETRY_ATTEMPTS 3       // RETRY TIME when Elect Remove happened

/* < DTS2015062902431 lugandong 20150725 begin */
static int removal_st;
/* DTS2015062902431 lugandong 20150725 end > */
...
/* DTS2015081900979 huangwei/wx223581 20150819 end > */
...
/* < DTS2015020408612 tianli/00220177 20150309 begin */
...
#endif
/* DTS2015020408612 tianli/00220177 20150309 end > */
...
#ifdef CONFIG_HUAWEI_KERNEL
/*< DTS2016030410779 chaofubang 20160315 begin */
		if(MBHC_PLUG_TYPE_GND_MIC_SWAP == plug_type){
			ad_logn("%s:GND MIC SWAP failed,unsupported plug type\n",__func__);
...
{
	int mask = 0;
	/* < DTS2015041505470 huangwei/wx223581 20150415 begin */
	switch (btn) {
	case 0:
		mask = SND_JACK_BTN_0;
	...
	/* DTS2015041505470 huangwei/wx223581 20150415 end > */
	return mask;
}
...
static int wcd_mbhc_initialise(struct wcd_mbhc *mbhc)
{
	...
	snd_soc_update_bits(codec, MSM8X16_WCD_A_ANALOG_MBHC_DET_CTL_2,
			0x01, 0x01);
    /* < DTS2015012805152 tianli/220177 20150328 begin */
    ...
    /* DTS2015012805152 tianli/220177 20150328 end > */
	/* enable MBHC clock */
	snd_soc_update_bits(codec,
		      ...
		      bool impedance_det_en)
{
	...
	if (mbhc->headset_jack.jack == NULL) {
		...
		/* < DTS2014112601380 lishubin 20140710 begin */
		/* regist new key for three button headset (from DTS2014070703002)*/
		ret = snd_jack_set_key(mbhc->button_jack.jack,
		                       SND_JACK_BTN_1,
		                       KEY_VOLUMEUP);
		if (ret) {
		...
		/* DTS2014112601380 lishubin 20140710 end > */
...
/* DTS2015073008247  penghongxing 20150806 end > */
