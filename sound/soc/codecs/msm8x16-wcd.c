...
static void msm8x16_wcd_set_auto_zeroing(struct snd_soc_codec *codec,
		bool enable);
static int msm8x16_wcd_get_spk_pa_swtich_status(void);
...
static const struct wcd_mbhc_cb mbhc_cb = {
	...
	.get_spk_pa_swtich_status = msm8x16_wcd_get_spk_pa_swtich_status,
};
...
static int msm8x16_wcd_get_spk_pa_swtich_status(void)
{
	ad_logn("%s:spk_ext_pa_switch_in_gpio is: %d\n",__func__,spk_ext_pa_switch_in_gpio );
	return spk_ext_pa_switch_in_gpio;
}
