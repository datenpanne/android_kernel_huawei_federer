...
/* < DTS2013122303240 sujunfeng 20131223 begin */
/* < DTS2014121808995 sujunfeng 20141227 begin */
/* device use diff gpio for hac , need do it adapt */
static int hac_en_gpio = 0;
#define DEFAULT_HAC_NONEED       0
/* DTS2014121808995 sujunfeng 20141227 end > */
...
/* DTS2013122303240 sujunfeng 20131223 end > */
...
/* < DTS2015041802116 jiangchenghu 20150420 begin */
...
/* < DTS2015052209361 jiangchenghu 20150611 begin */
int msm_quat_mi2s_clk = 0;
/* DTS2015052209361 jiangchenghu 20150611 end > */
extern bool get_tfa9895_flag(void);

static atomic_t quat_mi2s_clk_ref;
/* DTS2015041802116 jiangchenghu 20150420 end > */
...
/* < DTS2015091906191 jiangchenghu 20150919 begin */
        if (atomic_read(&pdata->mclk_rsc_ref) > 0) 
        {
...
/* DTS2015091906191 jiangchenghu 20150919 end > */
...
static int msm8916_hac_switch_get(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
    /* < DTS2014121609300 yubin 20150108 begin */
    /* < DTS2015031102936 yubin 20150312 begin */
    if(NULL == ucontrol)
    {
    ...
    /* DTS2015031102936 yubin 20150312 end > */
    /* DTS2014121609300 yubin 20150108 end > */
	return 0;
}
...
#undef S
	 ...
	 */
	 ...
	 /* < DTS2015031303199 matiantian 20150318 begin */
	...
	btn_low[4] = 537;
	btn_high[4] = 675;
	 /* DTS2015031303199 matiantian 20150318 end > */
...
static int msm8x16_asoc_machine_probe(struct platform_device *pdev)
{
	...
	/* DTS2014121808995 sujunfeng 20141227 end > */
	/* < DTS2014121205237 yubin 20141212 begin */
	/* < DTS2015032601844 matiantian 20150326 begin */
#ifdef CONFIG_HUAWEI_DSM
	struct timespec ts = {0, 0};
#endif
	/* DTS2015032601844 matiantian 20150326 end > */
	audio_dsm_register();
	/* DTS2014121205237 yubin 20141212 end > */
