...
#include <linux/of.h>
/* < DTS2015050300083 jiangchenghu 20150503 begin */
#include <linux/delay.h>
#include <linux/gpio.h>
#include <linux/of_gpio.h>
/* DTS2015050300083 jiangchenghu 20150503 end > */
...
/* < DTS2015121510232 y00188172 20151215 for add DMECNS begin*/
...
#define AUDIO_PROP_HANDHELD_DUAL_ENDFIRE_MIC_NODE "hand_held_dual_mic_endfire_strategy"
...
#define AUDIO_PROP_HANDHELD_DUAL_ENDFIRE_MIC 0x00008000
/* DTS2015121510232 y00188172 20151215 for add DMECNS end > */
/* DTS2013091308936 duhongyan 20130924 end > */
...
/* DTS2015050300083 jiangchenghu 20150503 end > */
    ...
    /* < DTS2015121510232 y00188172 20151215 for add DMECNS begin*/
    if(of_property_read_bool(pdev->dev.of_node, AUDIO_PROP_HANDHELD_DUAL_ENDFIRE_MIC_NODE))
    {
        audio_property |= AUDIO_PROP_HANDHELD_DUAL_ENDFIRE_MIC;
    }
    /* DTS2015121510232 y00188172 20151215 for add DMECNS end > */
...
/* < DTS2015050300083 jiangchenghu 20150503 begin */
    ...
    {
/* < DTS2015091508017 jiangchenghu 20150915 begin */
...
/* DTS2015091508017 jiangchenghu 20150915 end > */
    }
/* DTS2015050300083 jiangchenghu 20150503 end > */
