...
/*<DTS2015012801569 fanxiaozhen/wx272807 begin*/
...
#endif
#endif
/* DTS2015012801569 fanxiaozhen/wx272807 end >*/
...
{
	int i;
	/*<DTS2015012801569 fanxiaozhen/wx272807 20150206 begin*/
#ifdef CONFIG_HUAWEI_KERNEL
	static const char hide_machine_name[] = "unknown";
#endif
	/* DTS2015012801569 fanxiaozhen/wx272807 20150206 end >*/
	...
	seq_puts(m, "\n");
	/*<DTS2015012801569 fanxiaozhen/wx272807 20140205 begin*/
#ifdef CONFIG_HUAWEI_KERNEL
...
//Masking the machine name
	...
	seq_printf(m, "Hardware\t: %s\n", machine_name);
#endif
	/* DTS2015012801569 fanxiaozhen/wx272807 20140205 end >*/
	return 0;
}
...
static int __init init_runmode(char *str)
{
    ...
    /* <DTS2015012902741 wangbo 20140129 begin*/
    ...
    /* DTS2015012902741 wangbo 20140129 end >*/
    return 1;
}
