...
/*DTS2015012605554 weiqiangqiang 20150127 end>*/
...
/*<DTS2015011214070 yangyang&zhangxianfeng 20150112 begin*/
//static unsigned char fw_buf[1024*1024]={0};
/*DTS2015011214070 yangyang&zhangxianfeng 20150112 end>*/
/*DTS2015012605554 weiqiangqiang 20150127 end>*/
...
/* < DTS2015021106990 yangyang 20150211 begin */
...
/* MISP SELF-TEST END */
/* < DTS2015021106990  yangyang 20150211 end*/
...
/* <DTS2015041505528 xurenjie/wx208548 20150415 begin */
extern bool huawei_cam_is_factory_mode(void);
/* DTS2015041505528 xurenjie/wx208548 20150415 end> */
/* 
...
/* DTS2015011603233 houzhipeng 20150119 end > */
/* < DTS2015012802299 yangzhenxi 20150128 begin */
...
/* DTS2015012802299 yangzhenxi 20150128 end > */
/*< DTS2015012606635 tangying/205982 20150126 begin*/
/*add camera ois driver*/
...
/* < DTS2015011304316 yangzhenxi 20150113 begin */
/* < DTS2014122909996 houzhipeng 20141229 begin */
/* <DTS2015041505528 xurenjie/wx208548 20150415 begin */
int misp_load_fw(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	/*< DTS2015051105074 caohaiheng 20150511 begin*/
    msleep(5);
	/*DTS2015051105074 caohaiheng 20150511 end >*/
...
/* DTS2015011304316 yangzhenxi 20150113 end > */
/*< DTS2015031803765 ganfan/206212 20150318 begin*/
/*mini-isp do the ois init*/
...
out:
    ...
    /* <DTS2015063003509 xurenjie wx208548 20150701 begin */
    if(huawei_cam_is_factory_mode()){
        pr_err("%s: misp err, dump reg\n", __func__);
        misp_flush_reg();
    }
	/* DTS2015063003509 xurenjie wx208548 20150701 end  */
...
/* < DTS2015011603233 houzhipeng/yangyang 20150119 begin */
...
int misp_get_otp_data(struct msm_sensor_otp_info *otp_info, uint8_t cam_pos)
{
	...
	int i = 0;
	/* < DTS2015041001332 yangyang 20150410 begin */
	u8 param[9];
	/* < DTS2015041001332 yangyang 20150410 end*/
	u8 ctrl_byte = USPICTRL_MS_CB_DIS;
...
/* DTS2015011603233 houzhipeng/yangyang 20150119 end > */
