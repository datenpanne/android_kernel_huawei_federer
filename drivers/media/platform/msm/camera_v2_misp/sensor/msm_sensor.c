...
/* < DTS2014081209165 Zhangbo 00166742 20140812 begin */
/* < DTS2015040907276 Huqian/hwx282295 20150410 begin */
...
static int msm_sensor_check_module_vendor_with_otp(struct msm_sensor_ctrl_t *s_ctrl, int *read_otp)
{
	...
	if (*read_otp != 0)
	{
		/* < DTS2015011603233 houzhipeng 20150121 begin */
		if ((*read_otp >> 4) == s_ctrl->sensordata->slave_info->otp_vendor_id)
		/* DTS2015011603233 houzhipeng 20150121 end > */
		{
			rc = 0;
