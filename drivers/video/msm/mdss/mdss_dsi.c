...
#include <linux/clk.h>
/*< DTS2015013104683 tianye/293347 20150320 begin*/
/* optimize the screen wake up time*/
#include <linux/pm_qos.h>
/*DTS2015013104683 tianye/293347 20150320 end >*/
#include "mdss.h"
#include "mdss_panel.h"
#include "mdss_dsi.h"
#include "mdss_debug.h"
/*< DTS2015031101387 liyunlong 20150311 begin*/
/* a requirement about the production line test the leaky current of LCD  */
/* < DTS2015062402445 tianye 20150624 begin */
...
/* < DTS2015112101559 feishilin 20151121 begin */
/* < DTS2015121604891  feishilin 20151216 begin */
static void hw_panel_power_en(struct mdss_panel_data* pdata, int enable)
{
	...
	if (enable){
		if (1 == ctrl_pdata->which_product_pad){
			...
			/* < DTS2015112410140 zhangming 20151201 begin */
			...
			/*  DTS2015112410140 zhangming 20150716 end > */
	} else {
		if (1 == ctrl_pdata->which_product_pad){
			if (gpio_is_valid(ctrl_pdata->disp_vled_gpio)){
				gpio_set_value((ctrl_pdata->disp_vled_gpio), enable);
...
/*  DTS2015121604891  feishilin 20151216 end >*/
/*  DTS2015112101559 feishilin 20151121 end >*/
...
static int mdss_dsi_panel_power_ctrl(struct mdss_panel_data *pdata,
	int power_state)
{
/*< DTS2015032800063 tianye 20150328 begin */
...
/* DTS2015032800063 tianye 20150328 end > */
...
/* DTS2014080106240 renxigang 20140801 end > */
	...
	{
		if (gpio_is_valid(ctrl_pdata->disp_power_panel)){
				gpio_set_value((ctrl_pdata->disp_power_panel), 1);
				pr_info("%s,%d set disp_power_panel = 1 \n", __func__, __LINE__);
			}
		if (gpio_is_valid(ctrl_pdata->disp_power_backlight)){
			gpio_set_value((ctrl_pdata->disp_power_backlight), 1);
			pr_info("%s,%d set disp_power_backlight = 1 \n", __func__, __LINE__);
		}
		 mdelay(30);
	 }
	 /*  DTS2015112410140 zhangming 20151201 end > */
