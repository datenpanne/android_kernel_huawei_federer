...
#endif
/* DTS2015061105286 liujunchao 20150618 > */
...
/* < DTS2015043000445 tianye 20150430 begin */
...
/* DTS2015043000445 tianye 20150430 end > */
...
/* DTS2014091701123 huangli 20140917 end > */
		...
		if (ret == 0) {
/*< DTS2015011311872 renxigang 20150113 begin */
...
#endif
/* DTS2015011311872 renxigang 20150113 end >*/
...
/* < DTS2014062504641 zhaoyuxia 20140625 begin */
			mfd->op_enable = false;
/* < DTS2014120801330 zhengjinzeng 20141212 begin */
#ifdef CONFIG_HUAWEI_LCD
			cancel_delayed_work_sync(&mfd->bkl_work);
			LCD_LOG_DBG("%s: cancle bkl_delay work \n",__func__);
#endif
/* DTS2014120801330 zhengjinzeng 20141212 end > */
