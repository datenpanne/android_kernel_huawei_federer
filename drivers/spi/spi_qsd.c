...
static void msm_spi_process_transfer(struct msm_spi *dd)
{
	...
	u32 int_loopback = 0;
	int ret;
	/*< DTS2015073107530 houzhipeng 20150810 begin*/
	unsigned int __iomem *gpio;
	unsigned int gpio0;
	unsigned int gpio1;
	unsigned int gpio2;
	unsigned int gpio3;
	/*DTS2015073107530 houzhipeng 20150810 end >*/
	...
	do {
		if (!wait_for_completion_timeout(&dd->transfer_complete,
				...
				dev_err(dd->dev,
					...
					__func__);
				dd->cur_msg->status = -EIO;
				/* < DTS2015031209757 yangyang 20150312 begin */
				/*< DTS2015073107530 houzhipeng 20150810 begin*/
				//delete panic which we added for debug
				/*DTS2015073107530 houzhipeng 20150810 end >*/
				/* < DTS2015031209757  yangyang 20150312 end*/
				break;
		}
...
/* < DTS2015061202347 zhaoyuxia 20150612 begin */
...
/* DTS2015061202347 zhaoyuxia 20150612 end > */
