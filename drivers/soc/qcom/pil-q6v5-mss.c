...
/* DTS2014120901453 mazhenhua 20141209 end > */
#ifdef CONFIG_HUAWEI_KERNEL
#include <linux/sched.h>
#endif
/* DTS2014120901453 mazhenhua 20141209 end > */
/* < DTS2014122000899 wuzhihui 20141220 begin */
#ifdef CONFIG_HUAWEI_KERNEL
#include <linux/uaccess.h>
#include <linux/miscdevice.h>
#include <linux/fs.h>
#endif
/* DTS2014122000899 wuzhihui 20141220 end > */
...
/*< DTS2015021105813 mazhenhua 20150212 begin */
static struct work_data *g_work_data = NULL;
/* DTS2015021105813 mazhenhua 20150212 end >*/
...
static void log_modem_sfr(void)
{
	...
	/* < DTS2014121205237 yubin 20141212 begin */
	/* < DTS2015040106004 huangwei wx223581 20150401 begin */
	//move to the backward
	/* DTS2015040106004 huangwei wx223581 20150401 end > */
	/* DTS2014121205237 yubin 20141212 end > */
	/*<DTS2014122907589 mazhenhua 20141229 begin */
#ifdef CONFIG_HUAWEI_KERNEL
...
/* < DTS2014120901453 mazhenhua 20141209 begin */
#ifdef CONFIG_HUAWEI_KERNEL
...
static int modem_ramdump(int enable, const struct subsys_desc *subsys)
{
	...
	if (ret)
		return ret;
	/*< DTS2015031101537 yuanlonglong wx278700 20150701 begin */
	pr_err("%s:%d:pil do ramdump\n",__FILE__ ,__LINE__);
	/* DTS2015031101537 yuanlonglong wx278700 20150701 end >*/
