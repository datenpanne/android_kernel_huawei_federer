...
{
	/*< DTS2015020305205 mazhenhua 20150203 begin */
#ifdef CONFIG_HUAWEI_KERNEL
	...
	if (dev->desc->ramdump_disable_gpio)
		return !dev->desc->ramdump_disable;
#endif
	/* DTS2015020305205 mazhenhua 20150203 end >*/
		...
		const char __user *ubuf, size_t cnt, loff_t *ppos)
{
	...
	if (!strcmp(cmp, "restart")) {
		/*< DTS2015030502563 mazhenhua 20150318 begin*/
#ifdef CONFIG_HUAWEI_KERNEL
		if(subsys != NULL && subsys->desc != NULL)
			pr_info("trigger %s reset by debugfs\n", subsys->desc->name);
#endif
		/* DTS2015030502563 mazhenhua 20150318 end >*/
		/*< DTS2015031101537 yuanlonglong wx278700 20150701 begin */
