...
/* < DTS2015012605072 zhaoyingchun 20150126 begin */
#ifdef CONFIG_HUAWEI_KERNEL
#include <linux/fcntl.h>
#include <linux/syscalls.h>
/* < DTS2015032608630 sihongfang 20150326 begin*/
#ifdef CONFIG_HUAWEI_FEATURE_NFF
#include <linux/huawei_boot_log.h>
#endif
/* DTS2015032608630 sihongfang 20150326 end > */
...
#endif
/* DTS2015012605072 zhaoyingchun 20150126 end > */
...
/* < DTS2014120508127 zhaoyingchun 20141205 begin */
#ifdef CONFIG_HUAWEI_DEBUG_MODE
extern char *saved_command_line;
#endif
/* DTS2014120508127 zhaoyingchun 20141205 end > */
...
/* < DTS2014112409608 zhaoyingchun 20141125 begin */
#ifdef CONFIG_HUAWEI_KERNEL
...
#endif
/* DTS2014112409608 zhaoyingchun 20141125 end > */

/* < DTS2015042403842 hexinlong 20150424 begin*/
#ifdef CONFIG_HUAWEI_FEATURE_NFF
static uint32_t *reboot_flag_addr;
#endif
/* DTS2015042403842 hexinlong 20150424 end > */
