...
/* < DTS2015011300655 likang 20150113 begin */
/*
 *
...
#include "pn547.h"
/* < DTS2014041701954 yanhong/00202429 20140504 begin */
#include <linux/wakelock.h>
/* DTS2014041701954 yanhong/00202429 20140504 end > */
...
struct pn547_dev	{
	...
	/* < DTS2015100800697   jiaboyang 20151008 BEGIN */
	struct mutex		irq_wake_mutex;
	/* DTS2015100800697   jiaboyang 20151008 END > */
	struct device		*dev;
...
static irqreturn_t pn547_dev_irq_handler(int irq, void *dev_id)
{
	...
	/* < DTS2014050505516 yanhong/00202429 20140505 begin */
	wake_lock_timeout(&pn547_dev->wl, 1 * HZ);
	/* DTS2014050505516 yanhong/00202429 20140505 end > */
...
static ssize_t pn547_i2c_read(struct  pn547_dev *pdev,char *buf,int count)
{
	...
	/* < DTS2015021205104 likang 20150212 begin */
...
fail:
	mutex_unlock(&pdev->read_mutex);
	/* DTS2015021205104 likang 20150212 end > */
	return (size_t)ret;
}
...
static int check_sim_status(struct i2c_client *client, struct  pn547_dev *pdev)
{
	...
	/* < DTS2015051906760 jiaboyang 20150520 begin */
	...
	/* DTS2015051906760 jiaboyang 20150520 end > */
...
MODULE_LICENSE("GPL");
/* DTS2015011300655 likang 20150113 end > */
