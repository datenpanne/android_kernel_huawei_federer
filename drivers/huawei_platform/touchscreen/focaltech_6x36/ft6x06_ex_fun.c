...
/* <DTS2014070900044 y00278208 20140709 begin */
/* <DTS2014042901253 c00248442 20142904 begin */
/* DTS2014042901253 c00248442 20142904 end> */
...
/* DTS2014070900044 y00278208 20140709 end > */
...
void ft6x06_upgrade_with_i_handler(struct ft6x06_ts_data *ft6x06_ts)
{
    ...
    /* DTS2014070900044 y00278208 20140709 end > */
    /* <DTS2014042901253 c00248442 20142904 begin */
    /* < DTS2014050602440 caowei 201400512 begin */
    ...
    /* DTS2014050602440 caowei 201400512 end >*/
    /* DTS2014042901253 c00248442 20142904 end> */
...
/* < DTS2014010710074  weiqiangqiang  20140107 begin >*/
/* < DTS2014011305061  weiqiangqiang 20140113 begin >*/
void  fts_ctpm_auto_upgrade(struct work_struct *ft6x06_fw_config_delay)
{
   ...
   /* < DTS2014071601734 yanghaizhou 20140715 begin */
	...
	/* < DTS2014061208226 caowei 201400612 begin */
	if(rc < 0)
	{
		tp_log_err("error:%s,line=%d,rc=%d\n", __func__, __LINE__,rc);
	}
	...
	/* DTS2014061208226 caowei 201400612 end >*/
    ...
    {
        /* < DTS2014070900044 y00278208 20140709 begin*/
        /* DTS2014052603208 yanghaizhou 20140603 begin*/
        uc_host_fm_ver = fts_ctpm_get_i_file_ver(CTPM_FW_LANSI,fw_lansi_len);
        /* DTS2014052603208 yanghaizhou 20140603 end */
        /* DTS2014070900044 y00278208 20140709 end > */
...
/*< DTS2014011305061 weiqiangqiang 20140113 end > */
/* < DTS2014010710074  weiqiangqiang  20140107 end >*/
				...
				struct device_attribute *attr, char *buf)
{
	...
	if(ft6x06_read_reg(i2c_client, 0xA8, &tp_factory_id) < 0) {
        ...
        /* < DTS2014070900044 yanghaizhou 20140714 begin */
        ...
        /* DTS2014070900044 yanghaizhou 20140714 end > */
	}
				...
				struct device_attribute *attr, char *buf)
{
	...
	/* < DTS2014072300597  fanjiafeng 20140723 begin */
	tp_log_info("enter %s %d\n", __func__, __LINE__);
	/* DTS2014072300597  fanjiafeng 20140723 end > */
	/* < DTSDTS2014072200990 yanghaizhou 20140723 begin */	
