...
/* < DTS2015051502432  dingjingfeng 20150515 begin */
#ifdef CONFIG_HUAWEI_DSM
#include <linux/dsm_pub.h>
#endif/*CONFIG_HUAWEI_DSM*/
/* DTS2015051502432  dingjingfeng 20150515 end >*/


#define CY_CORE_STARTUP_RETRY_COUNT		3
/* < DTS2015012303198 songrongyuan 201500204 begin */
u8 tp_color_data = 0;
/* DTS2015012303198 songrongyuan 201500204 end >*/
...
/* < DTS2015012302601 songrongyuan 20150123 begin */
...
static void cyttsp5_watchdog_work(struct work_struct *work)
{
	...
	/* <DTS2015032008433 c00248442 20150407 begin */
	rc = request_exclusive(cd, cd->dev, CY_REQUEST_EXCLUSIVE_TIMEOUT);
	if (rc < 0) {
		tp_log_err( "%s: fail get exclusive ex=%p own=%p\n",
				__func__, cd->exclusive_dev, cd->dev);
	...
	/* DTS2015032008433 c00248442 20150407 end> */
	if (rc) {
		tp_log_err(
		...
		/* < DTS2015091203133 yuanbo 20150929 begin */
		...
		/* DTS2015091203133 yuanbo 20150929 end> */
		return;
	}
...
static int cyttsp5_parse_input(struct cyttsp5_core_data *cd)
{
	...
	/* < DTS2015052504009 wanglongfei 20150525 begin */
	...
	/* DTS2015052504009 wanglongfei 20150525 end >*/
...
static int cyttsp5_read_input(struct cyttsp5_core_data *cd)
{
	...
	int rc = 0;
	/* < DTS2015081106568 yuanbo 20150811 begin */
	unsigned int size = 0;
	...
	/* DTS2015081106568 yuanbo 20150811 end >*/
...
static int cyttsp5_core_wake_device_from_deep_sleep_(
		struct cyttsp5_core_data *cd)
{
	/* <DTS2015072101960 yuanbo 20150723 begin */
	int rc = -EAGAIN;
	int retry_times = 0;
	...
	for (retry_times = 0; retry_times < CY_WAKEUP_RETRY_TIMES; retry_times++) {
		...
		/* DTS2015080502185 yuanbo 20150805 end> */
	/* DTS2015072101960 yuanbo 20150723 end> */
...
static int cyttsp5_get_ic_crc_(struct cyttsp5_core_data *cd, u8 ebid)
{
	...
	if (status) {
		rc = -EINVAL;
/* <DTS2015083101863 zhangyize 20150901 begin */
...
/* DTS2015083101863 zhangyize 20150901 end> */
...
reset:
	...
	/* < DTS2015022602223 songrongyuan 20150226 begin */
...
/* DTS2015051502432  dingjingfeng 20150515 end >*/
	...
	/* DTS2015022602223 songrongyuan 20150226 end >*/
...
#endif
/* < DTS2015012303198 songrongyuan 201500204 begin */ 
/* < DTS2015062304424 zhouzhuang 20150623 begin */
...
/* DTS2015012303198 songrongyuan 201500204 end >*/
/* DTS2015062304424 zhouzhuang 20150623 end >*/
/* < DTS2015061007173  zhouzhuang 20150610 begin */
