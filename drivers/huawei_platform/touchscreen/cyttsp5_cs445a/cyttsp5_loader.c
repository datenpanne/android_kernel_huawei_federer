		...
		u32 fw_ver_new, u32 fw_revctrl_new)
{
	...
	/* < DTS2015041607290 yuanbo 20150417 begin */
	...
	/* < DTS2015073007462 yuanbo 20150731 begin */
	...
	if (FW_UPDATE_DIFF == cd->cpdata->fw_update_logic) {
		...
		/* DTS2015041607290 yuanbo 20150417 end> */
		if (fw_ver_new > fw_ver_img) {
	...
	/* DTS2015073007462 yuanbo 20150731 end> */
...
static void cyttsp5_calibrate_idacs(struct work_struct *calibration_work)
{
	...
	/* < DTS2015101903645 wushengyu 20151019 begin */
...
resume_scan:
	...
	/* DTS2015101903645 wushengyu 20151019 end >*/
release:
...
exit:
	...
	/* <DTS2015091408866 c00248442 20150914 begin */
	...
	/* DTS2015091408866 c00248442 20150914 end> */
