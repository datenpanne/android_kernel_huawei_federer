...
/* < DTS2014021201138 sunlibin 20140224 begin */
#define REPORT_GESTURE_LOCUS 1
/* DTS2014021201138 sunlibin 20140224 end> */
...
/*< DTS2015080402895  zhoumin wx222300 20150804 begin */
#define VBUS_DISABLE_TIMES 2
/* DTS2015080402895  zhoumin wx222300 20150804 end >*/
...
/* < DTS2014061601901 sunlibin 20140616 begin */
/* Doze wakeup threshold reg */
#define F01_RMI_CTRL03_OFFSET 3
/* DTS2014061601901 sunlibin 20140616 end> */
...
/* < DTS2014031300213 sunlibin 20140313 begin */
...
/* < DTS2014032705072 sunlibin 20140327 begin */
...
/* DTS2014032705072 sunlibin 20140327 end > */
...
/* DTS2014031300213 sunlibin 20140313 end> */

/* < DTS2014071501886  yangyang 20140724 begin */
/* For case that need driver to force calibrate TP */
#define FORCE_TIMEOUT_10MS 10
#define F54_FORCE_CAL 1<<1
/* DTS2014071501886  yangyang 20140724 end >*/
...
/* < DTS2014110600116 songrongyuan 20141106 begin */
...
/* DTS2014110600116 songrongyuan 20141106 end > */
...
/* < DTS2015041002257 zhoumin wx222300 20150410 begin */
...
/* DTS2015041002257 zhoumin wx222300 20150410 end> */
		...
		struct device_attribute *attr, char *buf)
{
	...
	struct synaptics_rmi4_data *rmi4_data = dev_get_drvdata(dev);
/* < DTS2014022509384 sunlibin 20140228 begin */
	/*for ESD test*/
...
/* DTS2014022509384 sunlibin 20140228 end> */
...
static int F51_set_glove_mode(struct synaptics_rmi4_data *rmi4_data,unsigned long value)
{
	...
	{
		/* < DTS2014091905806 sunlibin 20140919 begin */
...
/* DTS2014091905806 sunlibin 20140919 end> */
/* DTS2014120803003 songrongyuan 20141208 end> */
/* DTS2015030903154 fengzhiqiang/00217916 20150309 begin */
		...
		struct synaptics_rmi4_fn *fhandler)
{
	...
	/*Make sure the position be ready before wake up system*/
		...
		*input_sync(rmi4_data->input_dev);
		*/
		/* <DTS2015042905967 zhoujian/wx221429 20150429 begin */
		/*delete report power event */
		/* DTS2015042905967 zhoujian/wx221429 20150429 end> */
		...
		struct synaptics_rmi4_fn *fhandler)
{
	...
	int x;
	int y;
/* < DTS2014012308720 sunlibin 20140127 begin */
	int z;
/* DTS2014012308720 sunlibin 20140127 end> */
	int wx;
	int wy;
	int temp;
#ifdef CONFIG_HUAWEI_KERNEL
...
/* DTS2014011515693 sunlibin 20140212 end > */
			...
			x = check_scope_x(x,x_lcd);
			y = y * y_lcd_all / rmi4_data->sensor_max_y;
			/* < DTS2015070205611 chenyang/cwx206652 20150703 begin */
			/*Prevent  y equal the y_lcd*/
			if(y == rmi4_data->board->lcd_y)
				y = y - 1;
			/* DTS2015070205611 chenyang/cwx206652 20150703 end > */
#endif /*CONFIG_HUAWEI_KERNEL*/
...
/* DTS2014011515693 sunlibin 20140212 end > */
/* DTS2014012308720 sunlibin 20140127 end> */
	/* < DTS2014082103217 sunlibin 20140821 begin */
	if (retval < 0) {
		tp_log_err("%s: Failed to read interrupt status\n",
				__func__);
		goto REPORT_ERROR;
	...
	/* DTS2014082103217 sunlibin 20140821 end > */
...
/* < DTS2014011515693 sunlibin 20140212 begin */
		 ...
		 unsigned char page)
 {
	 ...
	 /* < DTS2014123008716 sunlibin 20141230 begin */
	 ...
	 /* DTS2014123008716 sunlibin 20141230 end > */
...
static int synaptics_rmi4_parse_dt(struct device *dev, struct synaptics_dsx_platform_data *pdata)
{
	...
	*/
	...
	/* DTS2014011515693 sunlibin 20140212 end > */
	/* < DTS2014080506603  caowei 201400806 begin */	
	/* < DTS2014083005839  caowei 201400902 begin */
...
static int i2c_communicate_check(struct synaptics_rmi4_data *rmi4_data)
{
	...
	for (i = 0; i < I2C_CHECK_RETRY_TIMES; i++) 
	{
		...
		if (retval < 0) 
		{
			...
			if(!pull_down_flag)
			{
				/*< DTS2015060907862  zhoumin/wx222300 20150609 begin */
				gpio_direction_output(rst_gpio, 1);//pull up
				/* DTS2015060907862  zhoumin/wx222300 20150609 end >*/
				msleep(5);
...
/* <DTS2015092905015 chenyang/cwx206652 20150929 begin */
...
/* DTS2015092905015 chenyang/cwx206652 20150929 end> */
/* DTS2015060300341 chenyang/cwx206652 20150401 end> */
/* <DTS2015010801501 sunlibin 20150108 begin */
/* Modify JDI tp/lcd power on/off to reduce power consumption */
/* <DTS2015010903865 sunlibin 20150109 begin */
...
static int synaptics_incell_power(bool enable,struct synaptics_rmi4_data *rmi4_data)
{
	...
	if(enable)
	{
		...
		/* <DTS2015020207525 sunlibin 20150203 begin */
		...
		/* DTS2015020207525 sunlibin 20150203 end> */
	}
	else
	{
...
/* < DTS2014011515693 sunlibin 20140212 begin */
		 if (*blank == FB_BLANK_UNBLANK)
		 {
			 ...
			 if (0 == runtime_count)
			 {
				 ...
				 /* < DTS2014040900788 chenyang/wx206652 20140409 begin */
				 ...
				 /* DTS2014040900788 chenyang/wx206652 20140409 end > */
			 }
			 else
			 {
...
/* < DTS2014073002882 songrongyuan 20140730 begin */
	...
	/*< DTS2015042902639 zhoumin wx222300 20150429 begin */
	...
	/* DTS2015042902639 zhoumin wx222300 20150429 end >*/
/* < DTS2014011515693 sunlibin 20140212 begin */
#ifdef CONFIG_PM
...
/* < DTS2014032108776 songrongyuan 20140321 begin */
#ifndef CONFIG_HUAWEI_KERNEL
	if (platform_data->power_gpio >= 0) {
		synaptics_gpio_setup(
				platform_data->power_gpio,
...
#endif /*CONFIG_HUAWEI_KERNEL*/
/* DTS2014032108776 songrongyuan 20140321 end > */
...
/* DTS2014011515693 sunlibin 20140212 end > */
	...
	/*< DTS2015080402895  zhoumin wx222300 begin */
	.shutdown = synaptics_rmi4_shutdown,
	/* DTS2015080402895  zhoumin wx222300 end >*/
};
