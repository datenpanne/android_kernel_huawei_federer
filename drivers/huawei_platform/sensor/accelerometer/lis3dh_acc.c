...
/*DTS2014061000435 cuixiaokang WX 225640 end*/
#define	DEBUG	1
			...
			struct lis3dh_acc_platform_data *pdata)
{
	...
	switch(temp_val){
		...
		/* DTS2014091702570 wanghang 20140916 end >*/
		/* DTS2014081907931 wanghang 20140819 end > */
		/* <DTS2015081901118 chendong 20150819 begin */
		/* <DTS2015072101855 chendong 20150812 begin */
		case GS_MAP_DIRECTION_NOREVERSAL:
			...
			break;
		/* DTS2015072101855 chendong 20150812 end> */
		/* DTS2015081901118 chendong 20150819 end> */
		default:
			pdata->axis_map_x = 0;
			pdata->axis_map_y = 1;
			pdata->axis_map_z = 2;
		...
		const struct i2c_device_id *id)
{
	...
	struct lis3dh_acc_data *acc;
	int err = -1;
	/* < DTS2015012200048 wanghang 20150203 begin */
	LIS3DH_INFO("%s,line %d: PROBE START.",__func__,__LINE__);
	/* DTS2015012200048 wanghang 20150203 end > */
	...
	mutex_init(&acc->lock);
	/* < DTS2015012202232 wuying/wx221431 20150122 begin */
	mutex_init(&acc->lock_i2c);
	/* DTS2015012202232 wuying/wx221431 20150122 end > */
	mutex_lock(&acc->lock);
...
/* < DTS2014072201656 yangzhonghua 20140722 begin */
	...
	if(err < 0){
		...
		/*<DTS2015012005310 liyunlong 20150120 begin */
		goto exit_kfree_pdata;
		/* DTS2015012005310 liyunlong 20150120 end> */
	}
	/* DTS2015012202232 wuying/wx221431 20150122 end > */
#endif
	/* DTS2014112604473 yangzhonghua 20141126 end> */
