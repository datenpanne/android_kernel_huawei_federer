/* < DTS2015072307644 hujianglei 20150724 begin */
/*<DTS2015021001035 liyunlong 20150210 begin */
...
/* DTS2014112202343 hufeng 20141122 begin */
/* removed lines */
/* DTS2014112202343 hufeng 20141122 end */
#include <asm/io.h>
...
/* DTS2015012105186 wangcunyou 20150121 end > */
/* < DTS2014122304450 wangcunyou 20141223 begin */
...
typedef enum hall_used_type{
	...
	/* DTS2014122304450 wangcunyou 20141223 end > */
} hall_used_type_t;
...
static struct sensors_classdev hall_cdev = {
	...
	.resolution = "1",
	.sensor_power = "0.002",
	/* < DTS2015051900704  hufeng/wx283838 20150520 begin */
	.min_delay = 0,
	/* DTS2015051900704  hufeng/wx283838 20150520 end > */
	.delay_msec = 200,
...
/* < DTS2015041508342 zhoujian wx221429 20150514 begin */
...
/* < DTS2014070815048 wangcunyou 20140708 begin */
/***************************************************************
...
/* DTS2014070815048 wangcunyou 20140708 end > */
/***************************************************************
...
/* < DTS2014030400248 yangxiaomei 20140305 begin */
				...
				struct device_attribute *attr, char *buf)
{
	int value = 0;
	value = query_hall_event();
	/* < DTS2015030904798 wushengyu 20150324 begin */
	/*report event to hal layer*/
	input_event(hw_hall_dev.hw_input_hall, EV_MSC, MSC_SCAN, value);
	input_sync(hw_hall_dev.hw_input_hall);
	/* DTS2015030904798 wushengyu 20150324 end > */
	return snprintf(buf, PAGE_SIZE, "%d\n", value);
}
...
/* DTS2014030400248 yangxiaomei 20140305 end > */
/* < DTS2015041508342 zhoujian wx221429 20150514 begin */
...
/* < DTS2015041508342 zhoujian wx221429 20150514 begin */
/* < DTS2015061101875 zhoujian/wx221429 20150611 begin */
/* < DTS2015061805564 zhoujian/wx221429 20150618 begin */
/*delete someline */
...
/* < DTS2015082804940 zhoujian/wx221429 20150831 begin */
...
/* DTS2015082804940 zhoujian/wx221429 20150831 end > */
/* DTS2015061805564 zhoujian/wx221429 20150618 end > */
/* DTS2015061101875 zhoujian/wx221429 20150611 end > */
/* DTS2015041508342 zhoujian wx221429 20150514 end > */
...
void hall_work_func(struct work_struct *work)
{
	...
	/* DTS2015041508712 zhoujian zwx221429 20150415 end > */
	/* DTS2015012105186 wangcunyou 20150121 end > */
	/* < DTS2015041508342 zhoujian wx221429 20150514 begin */
...
irqreturn_t hall_event_isr(int irq, void *dev)
{
	...
	int ret = 0;
	/* < DTS2014033106146 yangxiaomei 20140401 begin */
	int value_debounce = 0;
	/* DTS2014033106146 yangxiaomei 20140401 end > */
...
int hall_pf_probe(struct platform_device *pdev)
{
	...
	/* < DTS2015071501112 wanghang 20150715 begin */
	/*
	...
	/* DTS2015071501112 wanghang 20150715 end >*/
...
/* DTS2015021001035 liyunlong 20150210 end> */
/* DTS2015072307644 hujianglei 20150724 end >*/
