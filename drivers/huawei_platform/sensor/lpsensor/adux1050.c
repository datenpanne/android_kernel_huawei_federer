...
/* DTS2015021203856 dingjingfeng 20150212 begin> */
/**
*\mainpage
...
#endif
/* < DTS2015020605742  dingjingfeng 20150312 begin */
#include <misc/app_info.h>
/* DTS2015020605742   dingjingfeng 20150312 end > */
...
/* < DTS2015030601958   dingjingfeng 20150306 begin */
		data = SET_PWR_MODE(data, PWR_STAND_BY);
/* DTS2015030601958   dingjingfeng 20150306 end > */
...
{
/* < DTS2015073005780 wanghang 20150730 begin */
#ifdef CONFIG_EVAL
	s16 ret;
#endif
/* DTS2015073005780 wanghang 20150730 end >*/
...
{
	/* < DTS2015030301495  dingjingfeng 20150303 begin */
	/* < DTS2015032400386 dingjingfeng 20150326 begin */
	s16 ret;
...
/* DTS2015030301495  dingjingfeng 20150303 end > */
	if (val == ADUX1050_ENABLE) {
...
#endif
		/* < DTS2015032708741  dingjingfeng 20150327 begin */
		cancel_work_sync(&adux1050->work);
		cancel_work_sync(&adux1050->calib_work);
		/* DTS2015032708741 dingjingfeng 20150327 end > */
		adux1050_disable(adux1050);
		...
		/* DTS2015032400386 dingjingfeng 20150326 end > */
...
err_input_register_device:
	if (adux1050->input) {
		...
		/* < DTS2015021601098 wangcunyou 20150216 begin */
		/*input_unregister_device Already free device, dont use input_free_device again*/
		/* DTS2015021601098 wangcunyou 20150216 end > */
	}
err_detect_sensor:
err_power_on:
	if (regulator_count_voltages(adux1050->reg_vdd) > 0) {
...
MODULE_LICENSE("GPL");
/* DTS2015021203856 dingjingfeng 20150212 end> */
