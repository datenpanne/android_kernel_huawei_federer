...
/*< DTS2015012000564 zhangyonggang 20150120 begin*/
/* < DTS2015070912862 zhangyonggang 20150720 began */
/*deleted it,not use*/
	...
	if (val == 1) {
		 ...
		 */
		 if(data->enable_als_sensor == 1)
		 {
			...
			{
				/* < DTS2015052202170 zhangyonggang 20150522 begin */
				data->enable = PS_ALS_SET_MODE_CONTROL | pdata->pulse_width;
				/* DTS2015052202170 zhangyonggang 20150522 end > */
				rpr521_set_enable(client, data->enable);
			}
...
/* DTS2014071802506 wangcunyou 20140718 end > */
{
	...
	if (data->enable_ps_sensor==0) {
		...
		/* < DTS2015032008100 wanghang 20150320 begin */
		if (data->irq)
		{
			/* < DTS2014110303514 wanghang 20141104 begin */
			operate_irq(data,1,true);
		...
		/* DTS2015032008100 wanghang 20150320 end >*/
...
static int rpr521_init_client(struct i2c_client *client)
{
	struct rpr521_data *data = i2c_get_clientdata(client);
	int err;
	/*<  DTS2015040808228  zhangyonggang 20150423 begin  */
	unsigned int tmp = 0;
	/* DTS2015040808228  zhangyonggang 20150423 end >  */
	/* < DTS2014073005921 yangxiaomei 20140730 begin */
	/* < DTS2015052202170 zhangyonggang 20150522 begin */
	data->enable = PS_ALS_SET_MODE_CONTROL | data->platform_data->pulse_width;
