/* < DTS2014120204092 wangcunyou 20141202 begin */
...
/*< DTS2015052606418 zhangyonggang 20150527 begin */
#include <huawei_platform/touchscreen/hw_tp_common.h>
/*DTS2015052606418 zhangyonggang 20150527 end >*/
...
/* < DTS2015011400852 wangcunyou 20150114 begin */
/*del Invalid global variables*/
/* DTS2015011400852 wangcunyou 20150114 end > */
/* < DTS2014073005921 yangxiaomei 20140730 begin */
/*remove to .h file*/
/* DTS2014073005921 yangxiaomei 20140730 end > */
...
/* DTS2014082603327 yangxiaomei 20140902 end > */
/* < DTS2015091901392 wanghang 20150923 begin */
static bool mix_light = false;
/* DTS2015091901392 wanghang 20150923 end >*/
/* < DTS2015032411009 zhangyonggang  20150417 begin */
...
/*< DTS2015070202046 zhangyonggang 20150706 begin */
#define APDS993X_FLOW(x...) do {\
    if (apds993x_debug_mask >=2) \
        printk(KERN_ERR x);\
    } while (0)
/*  DTS2015070202046 zhangyonggang 20150706 end > */
/* DTS2015032411009 zhangyonggang  20150417 end > */
/* < DTS2014121803938 yangzhonghua 20141218 begin */

/* < DTS2015022601901 wanghang 20150227 begin */
/*delete it, no use check_type*/
/* DTS2015022601901 wanghang 20150227 end > */
...
struct apds993x_data {
	...
	/* < DTS2015032002696 wuying/wx221431 20150402 begin */
	struct delayed_work dsm_irq_work;
	/* DTS2015032002696 wuying/wx221431 20150402 end > */
#endif
	int irq;
...
/* < DTS2014112406300 wanghang 20141124 begin */
/* < DTS2014120505054 wangcunyou 20141206 begin */
...
/* DTS2014120505054 wangcunyou 20141206 end > */
/* DTS2014112406300 wanghang 20141124 end > */
...
/* < DTS2015042502597  zhangyonggang  20150425 begin */
static int als_polling_count=0;
/*  DTS2015042502597  zhangyonggang  20150425 end > */
/*
...
/* <DTS2014112604473 yangzhonghua 20141126 begin */
#ifdef CONFIG_HUAWEI_DSM
/* < DTS2015061803843  zhangyonggang 20150619 begin */
static bool check_ps_enable = true;
/* DTS2015061803843  zhangyonggang 20150619 end > */
/* < DTS2014072201656 yangzhonghua 20140722 begin */
...
static void apds_dsm_no_irq_check(struct apds993x_data *data)
{
	...
	*/
	...
	/* < DTS2015032002696 wuying/wx221431 20150402 begin */
	/*< DTS2015060100581 zhangyonggang 20150601 begin */
	schedule_delayed_work(&data->dsm_irq_work, msecs_to_jiffies(120));
	/* DTS2015060100581 zhangyonggang 20150601 end > */
	/* DTS2015032002696 wuying/wx221431 20150402 end > */
}
...
static int apds_dsm_report_err(int errno,struct apds993x_data *data)
{
	...
	/*<  DTS2015033003517  zhangyonggang  20150410  begin */
	if(size > -1)
	{
		dsm_client_notify(apds993x_lps_dclient, errno);
		APDS993X_ERR("%s:line:%d,size = %d\n",__func__,__LINE__,size);
	}
	/* DTS2015033003517  zhangyonggang 20150410  end > */
	return size;
}
/* DTS2014121803938 yangzhonghua 20141218 end > */
...
static int apds993x_i2c_write(struct i2c_client*client, u8 reg, u16 value,bool flag)
{
	...
	if(loop == 0){
        ...
        /* < DTS2015052202800  hufeng  20150526 begin */
		if(data->device_exist == true){     
#ifdef CONFIG_HUAWEI_DSM
		    apds_report_i2c_info(data,err);
#endif
		}
		 /* DTS2015052202800  hufeng  20150526 end > */
		/* DTS2014112604473 yangzhonghua 20141126 end> */
	}
	return err;
}
...
static void apds993x_als_polling_work_handler(struct work_struct *work)
{
	...
	if (lux_is_valid) {
		...
		/* < DTS2015031304217 hwx217426 begin */
		if (sensorDT_mode)
		{
			als_data_count++;
		}
		/* DTS2015031304217 hwx217426 end > */
	}
...
static int apds993x_sensor_parse_parameter(struct device *dev)
{
	...
	/* < DTS2015070912862 zhangyonggang 20150720 begin */
	if(rc)
	{
...
/* DTS2015070912862 zhangyonggang 20150720 end > */
/* DTS2015052606418 zhangyonggang 20150527 end >*/
/*
 * IOCTL support
 */
static int apds993x_enable_als_sensor(struct i2c_client *client, int val)
{
	...
	if (val == 1) {
		...
		if (data->enable_als_sensor == 0) {
			...
			/*  DTS2015032411009 zhangyonggang  20150417 end > */
			/* < DTS2015042502597  zhangyonggang  20150425 begin */
			/* < DTS2015052904446 wanghang 20150529 begin */
			als_polling_count=1;
			/* DTS2015052904446 wanghang 20150529 end >*/
			/* DTS2015042502597  zhangyonggang  20150425 end > */
...
static int apds993x_read_device_id(struct i2c_client *client)
{
	...
	if (id == 0x30) {
		...
		/* < DTS2015060408026 wanghang 20150604 begin */
		...
		/* DTS2015060408026 wanghang 20150604 end >*/
	} else if (id == 0x39) {
...
/* DTS2014120204092 wangcunyou 20141202 end > */
