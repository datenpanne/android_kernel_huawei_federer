...
#define	ALS_THRES_HIGH 	4000
#define	ALS_THRES_LOW 	0
...
{
	unsigned int lsb, msb, val;
	/* < CPM2016070500030  yanfei 20160707 begin */
	struct ap3426_data *data = i2c_get_clientdata(client);
	/* CPM2016070500030  yanfei 20160707 end > */
...
static irqreturn_t ap3426_irq(int irq, void *data_)
{
	...
	if(1==data->rels_enable)
	{
		cancel_delayed_work(&data->light_report_work);
	}
	/* CPM2016070500030  yanfei 20160707 end > */
