...
/* <DTS2014071003025 hufeng 20140710 begin */
#ifdef CONFIG_HUAWEI_KERNEL
#define AKM_DEBUG_IF			1
#else
#define AKM_DEBUG_IF			0
#endif
/* DTS2014071003025 hufeng 20140710 end> */
...
struct akm_compass_data {
	...
	int	rep_cnt;
	/* < DTS2015021208285 wanghang 20150212 begin */
	bool	rst_not_use_gpio;
	/* DTS2015021208285 wanghang 20150212 end > */
...
struct akm_excep_data{
	...
	int excep_err;
	char *reg_buf;
	/* < DTS2015051402813 wanghang 20150514 begin */
	bool data_ready;    //mark the data is ready or not
	/* DTS2015051402813 wanghang 20150514 end >*/
	...
	bool is_self_test)
{
	...
	/* < DTS2014112906570 wangcunyou 20141129 begin */
	/* Check ST bit */
	...
	/* DTS2015051402813 wanghang 20150514 end >*/
	/* DTS2014112906570 wangcunyou 20141129 end > */
		...
		unsigned int enable)
{
	...
	uint8_t mode;
	/* < DTS2014061000435 wanghang 20140623 begin */
	AKM09911_ERR("start akm_enable_set!\n");
	/* DTS2014061000435 wanghang 20140623 end > */
	...
	if (enable) {
		...
		if (akm->auto_report) {
			...
			/* < DTS2014100909130 wanghang 20141009 begin */
			mutex_lock(&akm->self_test_mutex);
			/* DTS2014100909130 wanghang 20141009 end >*/
				...
				struct akm_compass_data *akm)
{
	...
	if(!akm->rst_not_use_gpio)
	{
    	...
    	/* < DTS2014062309034 wanghang 20140623 begin */
	...
	/* DTS2015021208285 wanghang 20150212 end > */
    /* DTS2014062309034 wanghang 20140623 end > */
	/* < DTS2015032800844 caowei 20150319 begin */
...
static int akm_report_data(struct akm_compass_data *akm)
{
	...
	/* < DTS2015041603355 wanghang 20150417 begin */
#ifdef CONFIG_HUAWEI_DSM
	static unsigned long all_zero_count = 0;
#endif
	/* DTS2015041603355 wanghang 20150417 end >*/
	...
	do {
		...
		/* DTS2014122200599 wangcunyou 20141222 end > */
		/* <DTS2014081101328 hufeng 20140810 begin */
		if (ret == -EAGAIN) {
			/* <DTS2014080404019 hufeng 20140804 begin */
			/* <DTS2014082204736 hufeng 20140822 begin */
	...
	if (STATUS_ERROR(dat_buf[8])) {
		/* <DTS2015070914957 wuying/wx221431 20150709 begin */
		...
		/* DTS2015070914957 wuying/wx221431 20150709 end> */
		AKECS_Reset(akm, 0);
		return -EIO;
	}
