...
/* < DTS2015062407451 liuqiang/wx285385 20150627 begin */
void init_enhanced_navi_setting(fpc1020_data_t* fpc1020)
{
    ...
    switch (fpc1020->nav.input_mode)
    {
        ...
        case FPC1020_INPUTMODE_DPAD:
            ...
            fpc1020->nav.threshold_key_start_up = 200;//80
            fpc1020->nav.threshold_key_start_down = 200;//80
...
/* DTS2015062407451 liuqiang/wx285385 20150627 end > */
            ...
            if(fpc1020->nav.throw_event == 0)
            {
                ...
                if (key_code)
                {
                    active = 1;
                    {
                        ...
                        if (fpc1020->nav.move_down_cnt > 0 && key_code == KEY_DOWN)
                        {
...
static void process_navi_event(fpc1020_data_t* fpc1020, int dx, int dy, int finger_status)
{
    ...
    const int THRESHOLD_RANGE_DOUBLE_TAP = 3000;//1600;
