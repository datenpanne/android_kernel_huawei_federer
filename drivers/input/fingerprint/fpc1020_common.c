...
/* < DTS2015082603920 zhaoyuxia 20150826 begin */
...
/* DTS2015082603920 zhaoyuxia 20150826 end > */
...
/* < DTS2015042809974 tongyongjiao/wx205235 20150428 begin */
    temp_u8 = 0x12; /* internal supply */
/* DTS2015042809974 tongyongjiao/wx205235 20150428 end > */
    FPC1020_MK_REG_WRITE(reg, FPC102X_REG_FINGER_DRIVE_CONF, &temp_u8);
    error = fpc1020_reg_access(fpc1020, &reg);
    if (error)
        goto out;
...
static int fpc1020_write_sensor_1140_setup(fpc1020_data_t *fpc1020)
{
    ...
    temp_u64 = 0x333333333F3F3F3F;//0x0808080814141414;
    FPC1020_MK_REG_WRITE(reg, FPC102X_REG_SAMPLE_PX_DLY, &temp_u64);
    error = fpc1020_reg_access(fpc1020, &reg);
    if (error)
        goto out;
...
/* -------------------------------------------------------------------- */
/* < DTS2015051207555 zhaoyuxia 20150512 begin */
/* < DTS2015051209997 liuqiang 20150519 begin */
...
/* DTS2015051209997 liuqiang 20150519 end > */
/* DTS2015051207555 zhaoyuxia 20150512 end > */
/* -------------------------------------------------------------------- */
