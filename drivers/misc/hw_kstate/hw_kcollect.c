...
/* <DTS2015032002039 qindiwen 20150320 delete begin */

/* DTS2015032002039 qindiwen 20150320 delete end >*/
/*
...
static int kcollect_cb(CHANNEL_ID src, PACKET_TAG tag, const char *data, size_t len)
{
	...
	/* <DTS2015032002039 qindiwen 20150320 begin */
	...
	switch_mask = mask;
	/* DTS2015032002039 qindiwen 20150320 end >*/

/* < DTS2014112802124 zhongming 20141128 begin */
	pr_debug("hw_kcollect %s: src=%d tag=%d len=%d pg_switch_mask=%d\n", __func__, src, tag, (int) len, switch_mask);
/* DTS2014112802124 zhongming 20141128 end >*/
