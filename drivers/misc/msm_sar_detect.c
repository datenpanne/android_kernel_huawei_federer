/*DTS2016032401223 liuanqi 20160324 begin*/
...
static DEVICE_ATTR(saronline, S_IRUGO | S_IWUSR, online_show, online_store);
...
static int sar_msm_probe(struct platform_device  *pdev)
{
    ...
    ret = device_create_file(&pdev->dev, &dev_attr_saronline);
    if(ret)
...
MODULE_LICENSE("GPL");
/*DTS2016032401223 liuanqi 20160324 end*/
