...
#include "diag_usb.h"
#include "diag_mux.h"
/* < DTS2014121603568 wenshuai 20141202 begin */
#ifdef CONFIG_HUAWEI_FEATURE_DIAG_MDLOG
#include "diag_memorydevice.h"
#endif
/* DTS2014121603568 wenshuai 20141202 end > */
...
/* < DTS2014112104949 wangbo 20141121 begin */
/* < DTS2014041406679 zhanggong 20140414 begin */
					...
					&& (cmd_code == 0xF6))
			{
				if ((entry.cmd_code_lo <= subsys_id) && (entry.cmd_code_hi >= subsys_id))
				{
					...
					/* < DTS2014122203061 wangbo 20141222 begin */
					if( !(diag_send_data(entry, buf, len,data_type)) )
					{
						pr_err("%s: diag send data failed\n",__func__);
					}
					/* DTS2014122203061 wangbo 20141222 end > */
...
#endif
/* DTS2014041406679 zhanggong 20140414 end > */
/* DTS2014112104949 wangbo 20141121 end > */
		}
	}
