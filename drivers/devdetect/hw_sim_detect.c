...
unsigned int get_sim_status(unsigned int sim_detection_gpio)
{
    ...
    electrical_lvl = electrical_lvl?0:1;
...
static void sim_detect_work(struct work_struct *work)
{
    ...
    pr_err("wangxiaozhao:sim_detect_work\n"); 
...
{
    int ret = 0;
    pr_err("wangxiaozhao:sim_prob start\n");
    ...
    pr_err("wangxiaozhao:sim_prob end\n");
    return 0;
