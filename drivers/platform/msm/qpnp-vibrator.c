...
/* <DTSDTS2015121707225 liuanqi 20160204 begin */
#define QPNP_VIB_DEFAULT_DUR_PARAM	0
#define QPNP_VIB_MIN_DUR		30
/* DTSDTS2015121707225 liuanqi 20160204 end> */
...
static void qpnp_vib_enable(struct timed_output_dev *dev, int value)
{
	struct qpnp_vib *vib = container_of(dev, struct qpnp_vib,
					 timed_dev);
	/* DTS2014061000435 zhangyonggagn 20140617 begin  */  				 
	VIBRATOR_INFO("%s,value=%d\n",__FUNCTION__,value);
    /* DTS2014061000435 zhangyonggagn 20140617 end  */  
	mutex_lock(&vib->lock);
...
/* <DTSDTS2015121707225 liuanqi 20160204 begin */
		if(value<QPNP_VIB_MIN_DUR && vib->dur_param)
		value =30;
/* DTSDTS2015121707225 liuanqi 20160204 end> */
...
/* <DTSDTS2015121707225 liuanqi 20160204 begin */
	vib->dur_param = QPNP_VIB_DEFAULT_DUR_PARAM;
	rc = of_property_read_u32(spmi->dev.of_node,
			"dur-parameter", &temp_val);
	if (!rc) {
		vib->dur_param = temp_val;
	} else if (rc == -EINVAL) {
		VIBRATOR_ERR("Invalid duration parameter\n");
	}
/* DTSDTS2015121707225 liuanqi 20160204 end> */
