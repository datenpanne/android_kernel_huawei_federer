...
#define LDO_NUM					18
/* < DTS2015060600317 guochenguang 20150606 begin */
#define LDO_USEC_INTERVAL			1200
/* DTS2015060600317 guochenguang 20150606 end > */
...
#define KEY_UP_S 0
	...
	/* DTS2014091605946 wanghang 20140916 end >*/
	/* < DTS2015040906547 guoyongxiang 20150505 begin */
	...
	/*  DTS2015040906547 guoyongxiang 20150505 end >*/
#endif
/* DTS2014080106240 renxigang 20140801 end > */
...
static irqreturn_t qpnp_kpdpwr_bark_irq(int irq, void *_pon)
{
...
#ifdef CONFIG_HUAWEI_KERNEL
    /* < DTS2015012101808 chenxi 20150121 begin */
    /* < DTS2015042907978 sihongfang 20150429 begin */
	if(pon_rt_sts_kpdpwr_bark == (pon_rt_sts & pon_rt_sts_kpdpwr_bark))
	{
        /* < DTS2015030700787 chenxi 20150307 begin */
#ifdef CONFIG_MSM_DLOAD_MODE
        /* clear dload mode to reduce false triggering dump*/
        clear_dload_mode();
#endif
        /* DTS2015030700787 chenxi 20150307 end > */
    ...
    /* DTS2015042907978 sihongfang 20150429 end >*/
    /* DTS2015012101808 chenxi 20150121 end > */
#endif
    /* DTS2014022704350 wuzhihui 20140306 end > */
    /* DTS2014042700497 niuxiangyu 20140428 end > */
	...
	for(i = 0; i < LDO_NUM; i++){
		...
		if(LDO_ON_MASK & ldo_status2[i]){/* if LDO is on, then check status1 value*/
			...
			if(!(LDO_VOL_MASK & ldo_status1[i])){
				/*< DTS2015012301199 jiangfei 20150123 begin */
				/*< DTS2015060600317 guochenguang 20150606 begin */
				...
				/* DTS2015012301199 jiangfei 20150123 end > */
				rc = qpnp_read_ldo_status_reg(pon, STATUS1_OFFSET, i, &ldo_status1[i]);
				if (rc) {
					pr_err("Unable to read LDO status1 reg value\n");
					return;
