...
/* < DTS2014120207212 lizhigang 20141202 begin */
...
#endif
/* DTS2014120207212 lizhigang 20141202 end > */
static int mmc_blk_issue_flush(struct mmc_queue *mq, struct request *req)
{
	...
	struct mmc_card *card = md->queue.card;
	int ret = 0;
/* < DTS2015040703450 wangjiquan 20150408 begin */
#ifdef CONFIG_HUAWEI_KERNEL
	static int timeout_count = 0;
#endif
/* DTS2015040703450 wangjiquan 20150408 end > */
...
static const struct mmc_fixup blk_fixups[] =
{
	...
	MMC_FIXUP("MMC32G", CID_MANFID_TOSHIBA, CID_OEMID_ANY, add_quirk_mmc,
		  MMC_QUIRK_BLK_NO_CMD23),
    /* < DTS2015110700761 cwx212840 20151109 begin */
	MMC_FIXUP("SD16G", 0x41, 0x3432, add_quirk_sd,
		  MMC_QUIRK_BLK_NO_CMD23),
	MMC_FIXUP("SD16G", 0x82, 0x4a54, add_quirk_sd,
		  MMC_QUIRK_BLK_NO_CMD23),
    /* DTS2015110700761 cwx212840 20151109 end > */
	/*
