...
static int mmc_read_ssr(struct mmc_card *card)
{
	...
	/* < DTS2015042701812 youqi 20150430 begin */
#ifdef CONFIG_HUAWEI_KERNEL
	card->ssr.speed_class = UNSTUFF_BITS(ssr, 440 - 384, 8); 
#endif
	/* DTS2015042701812 youqi 20150430 end > */
...
int mmc_sd_get_cid(struct mmc_host *host, u32 ocr, u32 *cid, u32 *rocr)
{
	int err;
	u32 max_current;
    /* BEGIN PN:DTS2015092209630, Modified by d00168349, 2015/09/25 */
    /*
     * change retry time from 10 to 5,to avoid suspend or resume 12s
     * timeout panic,especially bad card
     */
	int retries = 5;
    /* END PN:DTS2015092209630, Modified by d00168349, 2015/09/25 */

	/*< DTS2015111805730 yuanxiaofeng 20151125 begin */
#ifdef CONFIG_HUAWEI_KERNEL
	int cmd11_retries = 3;
#endif
	/* DTS2015111805730 yuanxiaofeng 20151125 end>*/
	...
	struct mmc_card *oldcard)
{
	...
	u32 rocr = 0;
	/*< DTS2015030405961 shangsai 20150304 begin */
    /*< DTS2015040902592  zengwei 20150409 begin */
#ifdef CONFIG_HUAWEI_SDCARD_DSM
	int i=0;
#endif
    /* DTS2015040902592  zengwei 20150409 end */
	/* DTS2015030405961 shangsai 20150304 end */
