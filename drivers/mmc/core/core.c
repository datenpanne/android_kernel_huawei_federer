...
/* DTS2015060500913 duanhuan 20150604 > */
#include <linux/mmc/dsm_emmc.h>
#endif
/* < DTS2014120902096 duanhuan 20141209 end > */

/* BEGIN PN:DTS2015072906971  , Modified by cwx212840, 2015/07/29 */
#include <linux/hw_sd_common.h>
/* END PN:DTS2015072906971  , Modified by cwx212840, 2015/07/29 */

/* < DTS2014112903902 lizhigang 20141129 begin */
#ifdef CONFIG_HUAWEI_KERNEL
#include <linux/debugfs.h>
#endif
/* DTS2014112903902 lizhigang 20141129 end > */
...
/* < DTS2014121202435 duanhuan 20141212 begin */
EXPORT_SYMBOL(mmc_set_clock);
/* DTS2014121202435 duanhuan 20141212 end > */
...
void mmc_power_up(struct mmc_host *host)
{
	 ...
	 */
	/*< DTS2014112401629 luchao 20141119 begin */
	...
	mmc_delay(10);
#endif
	/* DTS2014112401629 luchao 20141119 end>*/
...
int _mmc_detect_card_removed(struct mmc_host *host)
{
	...
	if(!strcmp(mmc_hostname(host), "mmc1"))
	{
		for(i=0; i< DSM_SDCARD_CMD_MAX; i++)
		{
			...
			/*< DTS2015030405961 shangsai 20150304 begin */
			dsm_sdcard_cmd_logs[i].manfid = 0;
			/* DTS2015030405961 shangsai 20150304 end */
		}
...
int mmc_flush_cache(struct mmc_card *card)
{
	...
	if (mmc_card_mmc(card) &&
		...
		if (err == -ETIMEDOUT) {
			...
			/* < DTS2015060402699 duanhuan 20150604 begin */
#ifdef CONFIG_HUAWEI_DSM
			if(mmc_card_mmc(card)){
				DSM_EMMC_LOG(card, DSM_EMMC_CACHE_ERR,
...
#endif
			/* DTS2015060402699 duanhuan 20150604 end > */
			pr_err("%s: cache flush error %d\n",
					mmc_hostname(card->host), err);
		}
	}
					...
					unsigned long mode, void *unused)
{
	...
	case PM_SUSPEND_PREPARE:
		 ...
		 */
		 /*< DTS2015102901665 zengwei 20151027 begin */
#ifdef CONFIG_MMC_BLOCK_DEFERRED_RESUME
		...
		cancel_delayed_work_sync(&host->detect);
#endif
		/* DTS2015102901665 zengwei 20151027 end>*/
		/*
