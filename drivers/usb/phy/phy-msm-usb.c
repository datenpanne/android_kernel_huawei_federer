...
#endif
/* < DTS2014121802462 wenshuai 20141218 begin */
...
#endif
/* DTS2014121802462 wenshuai 20141218 end > */
...
/* < DTS2015060802699 zhangjian 20150616 begin*/
		if (!motg->host_mode){
...
/* DTS2015060802699 zhangjian 20150616 end > */
}
...
static int msm_otg_reset(struct usb_phy *phy)
{
	 ...
	 */
    /* < DTS2015060504009 20150605 zhanggong begin */
    ...
    /* DTS2015060504009 20150605 zhanggong end > */
...
/* <DTS2015031100753 zhangjian 20150311 begin */
#define HOST_SUSPEND_WQ_TIMEOUT_MS	msecs_to_jiffies(2000) /* 2 seconds */
/* DTS2015031100753 zhangjian 20150311 end> */
...
/* < DTS2015060802699 zhangjian 20150616 begin*/
/* < DTS2015082707284 lizhifeng lwx292199 20150907 begin*/
        if(atomic_read(&motg->in_lpm)) {
            pm_runtime_resume(motg->phy.dev);
        }
        ulpi_init(motg);
/* DTS2015082707284 lizhifeng lwx292199 20150907 end > */
/* DTS2015060802699 zhangjian 20150616 end > */
...
/*< DTS2016031805114  ywx204768 20160318 begin */  
extern void usb_recovery_GSM_power(void);
extern void usb_reduce_GSM_power(void);
/*DTS2016031805114  ywx204768 20160318 end >*/
...
static void msm_hsusb_vbus_power(struct msm_otg *motg, bool on)
{
	...
	/* < DTS2015030604703 wenshuai 20150306 begin */
#ifdef CONFIG_HUAWEI_KERNEL
	usb_logs_err("msm_hsusb_vbus_power set vubs from  %d to %d\n", vbus_is_on, on);
#endif
	/* DTS2015030604703 wenshuai 20150306 end > */
	if (vbus_is_on == on)
		return;
	...
	if (!vbus_otg) {
		/* < DTS2015091507550 tanyanying 20150917 begin */
		/*delete nouse log*/
		/* DTS2015091507550 tanyanying 20150917 end > */
		return;
	}
...
static void msm_chg_detect_work(struct work_struct *w)
{
	...
	case USB_CHG_STATE_WAIT_FOR_DCD:
		...
		if (is_dcd || tmout) {
			if (is_dcd)
				dcd = true;
			/* < DTS2015030603365 shukai/wx221430 20140331 begin */
			else
				dcd = false;
            //remove 21302 usb radia monitor point
			/* DTS2015030603365 shukai/wx221430 20140331 end > */
...
void msm_id_status_changed(USB_ID_STATUS_TYPE id_state)
{
    ...
    if (id_state) {
        ...
        /* < DTS2015080304629 wenshuai 20150803 begin */
        if (is_usb_chg_exist() == 0 && test_and_clear_bit(ID, &motg->inputs)) {
        /* DTS2015080304629 wenshuai 20150803 end > */
	    usb_logs_info("ID clear\n");
            set_bit(A_BUS_REQ, &motg->inputs);
            work = 1;
        }
				  ...
				  union power_supply_propval *val)
{
	...
	/* <DTS2015012707311 jiangfei 20150202 begin */
		/* <DTS2015032004020 jiangfei 20150320 begin */
#ifdef CONFIG_HUAWEI_KERNEL
...
#endif
		/* DTS2015032004020 jiangfei 20150320 end> */
	/* DTS2015012707311 jiangfei 20150202 end> */
	/* <DTS2014061007024 chenyuanquan 20140610 begin */
		break;
				  ...
				  const union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_TYPE:
		...
		case POWER_SUPPLY_TYPE_USB_DCP:
			/* < DTS2014120903218 chenyuanquan 20141222 begin */
#ifdef CONFIG_HUAWEI_KERNEL
...
#endif
			/* DTS2014120903218 chenyuanquan 20141222 end > */
			motg->chg_type = USB_DCP_CHARGER;
			break;
...
static int msm_otg_probe(struct platform_device *pdev)
{
	...
	if (motg->pdata->mode == USB_OTG &&
		...
		if (id_irq) {
            ...
            set_bit(ID, &motg->inputs);
            /* < DTS2015011404441 wenshuai 20150114 begin */
            motg->caps = ALLOW_PHY_POWER_COLLAPSE | ALLOW_PHY_RETENTION;
            /* DTS2015011404441 wenshuai 20150114 end > */
#endif		
            /* DTS2014122907766 chenxi 20141229 end > */
		}
	}
