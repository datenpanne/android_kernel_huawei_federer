    ...
    struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    /* < DTS2015012906112 yuanzhen 20150129 begin */
    if(this_client)
    {
    ...
    /* DTS2015012906112 yuanzhen 20150129 end > */
    ...
    /* < DTS2015032802693 wenshuai 20150331 begin */
    enable_irq_wake(client->irq);
    /* DTS2015032802693 wenshuai 20150331 end > */
    /* clear INT MASK */
    reg_ctl = fsa9685_read_reg(FSA9685_REG_CONTROL);
    if ( reg_ctl < 0 ) {
        hwlog_err("%s: read FSA9685_REG_CONTROL error!!! reg_ctl=%d.\n", __func__, reg_ctl);
