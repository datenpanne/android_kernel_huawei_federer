...
#include "f_fs.c"
/* < DTS2015013107842 wenshuai 20150202 begin */
#ifdef CONFIG_HUAWEI_KERNEL
#include "f_fs_hdb.c"
#endif
/* DTS2015013107842 wenshuai 20150202 end > */
...
/* < DTS2015050706867  s00258714 20150507 begin */
#include <linux/rtc.h>
...
/* < DTS2015050706867  s00258714 20150507 end */
...
/* < DTS2015090400412 wenshuai 20150915 begin */
#ifdef CONFIG_HUAWEI_USB
static LIST_HEAD (android_dev_list );
#else
static struct list_head android_dev_list;
#endif
/* DTS2015090400412 wenshuai 20150915 end > */
...
static int _send_gsm_power_flag = 0;
static struct android_dev *_android_dev;

void usb_reduce_GSM_power(void)
{
	char *GSM_power_switch[2]    = { "USB_OTG_ON=1", NULL };
	usb_logs_info("usb send uevent (%s).\n", GSM_power_switch[0]);

	if(_android_dev != NULL)
		kobject_uevent_env(&_android_dev->dev->kobj, KOBJ_CHANGE, GSM_power_switch);
        _send_gsm_power_flag = 1;

	return;
}
EXPORT_SYMBOL( usb_reduce_GSM_power );

void usb_recovery_GSM_power(void)
{
	char *GSM_power_switch_off[2]    = { "USB_OTG_ON=0", NULL };
	usb_logs_info("usb send uevent (%s).\n", GSM_power_switch_off[0]);

	if(_send_gsm_power_flag&&(_android_dev != NULL))
		kobject_uevent_env(&_android_dev->dev->kobj, KOBJ_CHANGE, GSM_power_switch_off);
	_send_gsm_power_flag = 0;

	return;
}
EXPORT_SYMBOL( usb_recovery_GSM_power );
...
static ssize_t is_otg_online_show(struct device *pdev, struct device_attribute *attr,
                           char *buf)
{
        if(usb_get_id_state()){
...
static DEVICE_ATTR(is_otg_online, S_IRUGO, is_otg_online_show, NULL);
/*DTS2016031805114  ywx204768 20160318 end >*/
/* DTS2015072904152 xiazengtao 20150729 begin*/
